...
const initialOrders = [
  { id: '#DR-1082', customer: 'Nguyễn Văn A', drone: 'VN-201', locker: 'Locker S-04', status: 'Delivering', eta: '12 min' },
  { id: '#DR-1081', customer: 'Trần Minh B', drone: 'VN-144', locker: 'District 1 Balcony', status: 'Delivered', eta: 'Done' },
  { id: '#DR-1080', customer: 'Lê Văn C', drone: 'VN-102', locker: 'Skyway Station A', status: 'Pending', eta: '28 min' },
];
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 shrink-0">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <button 
              ...
              className="bg-brand-red text-white hover:bg-brand-red-dark transition-colors px-4 py-2 text-sm font-bold rounded-xl flex items-center gap-2 whitespace-nowrap shadow-md shadow-brand-red/20 focus:outline-none focus:ring-2 focus:ring-brand-red focus:ring-offset-2"
            >
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="text-sm font-medium text-gray-800">
              ...
              {filteredOrders.length === 0 && (
                <tr>
                  <td colSpan={6} className="p-8 text-center text-gray-500 font-medium">No orders found matching "{searchTerm}"</td>
                </tr>
              )}
            </tbody>
          </table>
